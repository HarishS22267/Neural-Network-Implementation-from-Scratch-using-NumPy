...
class structure():
    ...
    # def backward(self):
    #     print("Layer:", lay_num)
    #     print("dweights shape:", self.dense["layer_"+str(lay_num)].dweights.shape)
    #     print("dbiases shape:", self.dense["layer_"+str(lay_num)].dbiases.shape)
    #     print("dinputs shape:", self.dense["layer_"+str(lay_num)].dinputs.shape)
    ...
    def backward(self):
        for lay_num in reversed(range(0, len(self.model), 1)):
            ...
            print("weights shape:", self.dense["layer_" + str(lay_num)].weights.shape)
            print("dweights shape:", self.dense["layer_" + str(lay_num)].dweights.shape)
            print("biases shape:", self.dense["layer_" + str(lay_num)].biases.shape)
            print("dbiases shape:", self.dense["layer_" + str(lay_num)].dbiases.shape)
            print("dinputs shape:", self.dense["layer_" + str(lay_num)].dinputs.shape)
